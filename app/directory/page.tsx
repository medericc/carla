...
export default function Directory() {
  ...
  return (
    <div className="p-4 md:p-6">
      ...
      <div className="mb-4 grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-center">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center">
          <label htmlFor="num-results" className="mb-1 sm:mb-0 sm:mr-2 text-sm">Top :</label>
          <input
            id="num-results"
            type="number"
            value={numResults}
            onChange={(e) => setNumResults(Number(e.target.value))}
            className="border p-2 text-black rounded w-16 sm:mr-2"
            min={1}
          />
        ...
        <div className="flex flex-col sm:flex-row sm:items-center">
          <label htmlFor="num-results" className="mb-1 sm:mb-0 sm:mr-2 text-sm">Rang :</label>
        ...
        <button
          ...
          className="btn sm:col-span-2 bg-red-800 text-white p-2 rounded mt-2"
        >
          Filtrer
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {filteredData.map((match, index) => (
          <div
            key={index}
            className="border p-4 rounded-lg shadow-lg bg-white text-center"
          >
