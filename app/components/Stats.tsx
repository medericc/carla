...
const statsData = [
  ...
  { label: "Seule européenne meilleure scoreuse de LFB avec 40% à 3pts 🌟", value: 16.4 },
  { label: "Plus grand nombre de trophées de joueuse la plus décisive 🌟", value: 2 },
  { label: "Plus grand nombre de points par une européenne avec 40%+ à 3pts en LFB 🌟", value: 16.4 },
