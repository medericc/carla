...
const statsData = [
  ...
  { 
    label: "Seule Européenne Topscorer à 40% à 3pts", 
    value: "16.4",
    icon: FaBullseye,
  ...
  { 
    label: "Joueuse la Plus Décisive de LFB", 
    value: "2",
    icon: FaAward,
  ...
  { 
    label: "Européenne avec 40%+ à 3pts en LFB", 
    value: "16.4",
    icon: FaFire,
  ...
  { 
    label: "Meilleure Moyenne Pts+Ast à 20 ans en LFB", 
    value: "20.3",
    icon: FaLightbulb,
  ...
  { 
    label: "Meilleur Total Pts+Ast sur 3 Saisons en LFB", 
    value: "20.3",
  ...
  { 
    label: 'Plus Vieille à Atteindre 20 ppg en PO LFB', 
    value: '20',
    icon: FaMedal,
    color: 'from-red-600 to-orange-500',
    category: 'Vieillesse'
   ...
   { 
    label: 'Plus Jeune à Atteindre 20 ppg en PO LFB', 
    value: '20',
    icon: FaMedal,
    color: 'from-red-600 to-orange-500',
    category: 'Jeunesse'
   ...
   { 
    label: 'Plus Vieille à Atteindre 20 epg en PO LFB', 
    value: '20',
    icon: FaMedal,
    color: 'from-red-600 to-orange-500',
    category: 'Vieillesse'
   ...
   { 
    label: 'Plus Jeune à Atteindre 20 epg en PO LFB', 
    value: '20',
    icon: FaMedal,
    color: 'from-red-600 to-orange-500',
    category: 'Jeunesse'
  ...
  { 
    label: 'Première à Éliminer Bourges en Quart en MVP', 
    value: '26 pts',
    icon: FaFire,
  ...
  { 
    label: 'Joueuse des PO LFB à finir à +20 ppg', 
    value: '21',
    icon: FaHistory,
  ...
  { 
    label: 'Plus Jeune à être Plus décisive des Eurocup PO', 
    value: '20',
    icon: FaAward,
  ...
  { 
    label: '+160 Pts à 55 % en Coupe d\'Europe', 
    value: '176',
    icon: FaBullseye,
    color: 'from-amber-600 to-yellow-500',
    category: 'Précision'
  ...
  { 
    label: '26 points à 90% en PO LFB', 
    value: '26 pts',
    icon: FaLightbulb,
  ...
  { 
    label: 'Plus Large Victoire de l\'histoire de l\'EDF',
    value: '101',
    icon: FaUsers,
  ...
  { 
    label: 'Affluence Pour un Premier Match WNBA', 
    value: '18,064',
    icon: FaUsers,
